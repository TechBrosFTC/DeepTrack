...
public class DriveConstants {
    ...
    public static final double MAXIMUM_DRIVE_SPEED = MOTOR_MAX_RPM * GEAR_RATIO * Math.PI * WHEEL_DIAMETER / 3600; //Don't change this formule unless you know what you are doing, this is the teoretically max acceleraccion
    public static final double CM_PER_TICK = (WHEEL_DIAMETER * Math.PI) / (MOTOR_TICKS_PER_REV/ GEAR_RATIO);
